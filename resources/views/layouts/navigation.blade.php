<div class="bg-gray-100" x-data="{ sidebarOpen: false, sidebarMini: false }">
	<!-- Main Wrapper -->
		...
		<div class="header">
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop">
					<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                        <img class="user-img" src="assets/img/profiles/avatar-01.jpg" alt="default-profile">
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu">
							<a href="#"><i class="la la-cube"></i> <span>Services</span> <span
									class="menu-arrow"></span></a>
							<ul style="display: none;">
						...
						<li class="submenu">
							<a href="#" class="noti-dot"><i class="la la-user"></i> <span> Employees</span> <span
									class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="{{ route('user-management.index') }}">All Employees</a></li>
								...
								<li><a href="overtime.html">Activity Logs</a></li>
							</ul>
						</li>
						<li>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="active" href="apptitude-result.html"> Aptitude Results </a></li>
							</ul>
						</li>
						<li>
